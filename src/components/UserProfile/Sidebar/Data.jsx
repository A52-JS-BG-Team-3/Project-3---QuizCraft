...
const Data = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                const unsubscribe = onValue(userRef, (snapshot) => {
                    ...
                    setUserData((prevUserData) => ({
                      ...prevUserData,
                      userFullName: `${updatedUserData.firstName || ''} ${updatedUserData.lastName || ''}`,
    ...
    return (<VStack as="ul" spacing={0} listStyleType="none">
    <Box
      as="li"
      w="full"
      py={3}
      ...
      borderColor="black"
    >
      <Text color="brand.dark">Quiz score :</Text>
    ...
    <Box
      ...
      borderColor="black"
    >
      <Text color="brand.dark">User Full Name</Text>
      <Text color="brand.dark" fontWeight="bold">
    ...
    <Box
      ...
      borderColor="black"
    >
      <Text color="brand.dark">User Email</Text>
      <Text color="brand.dark" fontWeight="bold">
        {userData?.userEmail || ""}
      </Text>
    </Box>
